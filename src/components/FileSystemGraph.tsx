    ...
    nodesRef.current = data.nodes.map((node) => {
      ...
      if (node.type === "root") {
        ...
        if (parent) {
          ...
          startX = parent.x || w / 2 + Math.cos(angle) * distance;
          startY = parent.y || h / 2 + Math.sin(angle) * distance;
        } else {
        ...
        if (parent) {
          ...
          startX = parent.x + Math.cos(angle) * distance;
          startY = parent.y + Math.sin(angle) * distance;
        } else {
